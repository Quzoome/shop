...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
        ...
        <div class="inputBox">
            <span>Изображение 2 (обязательно)</span>
            <input type="file" name="image_02" accept="image/jpg, image/jpeg, image/png, image/webp" class="box" required>
        </div>
        <div class="inputBox">
            <span>Изображение 3 (обязательно)</span>
      ...
      <input type="submit" value="Добавить товар" class="btn" name="add_product">
   </form>
...
<section class="show-products">
   ...
   <h1 class="heading">Добавленные товары</h1>
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Удалить этот товар?');">Удалить</a>
      </div>
   </div>
   <?php
         }
