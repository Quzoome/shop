...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="email" name="email" required placeholder="Введите вашу почту" maxlength="50"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      ...
      <input type="password" name="cpass" required placeholder="Подтвердите пароль" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
