...
<section class="products">
   ...
   <h3 class="heading">Список желаний</h3>
   ...
   <?php
      ...
      echo '<p class="empty">Список желаний пуст!</p>';
   }
   ?>
   </div>
   ...
   <div class="wishlist-total">
      ...
      <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('Удалить всё из списка?');">Удалить всё</a>
   </div>
